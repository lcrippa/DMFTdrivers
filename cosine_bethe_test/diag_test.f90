program realistic_soc
  ...
  !
  spinorbit_matrix_t2g(1,:) = (-0.5)*[  zero,   one,   zero,   zero,  zero,   one]
  spinorbit_matrix_t2g(2,:) = (-0.5)*[   one,  zero,   zero,   zero,  zero,   one]
  spinorbit_matrix_t2g(3,:) = (-0.5)*[  zero,  zero,   zero,    one,   one,  zero]
  spinorbit_matrix_t2g(4,:) = (-0.5)*[  zero,  zero,    one,   zero,   one,  zero]
  spinorbit_matrix_t2g(5,:) = (-0.5)*[  zero,  zero,    one,    one,  zero,  zero]  
  spinorbit_matrix_t2g(6,:) = (-0.5)*[   one,   one,   zero,   zero,  zero,  zero] 
  ...
  print*,"Hloc is"
  call print_c_matrix(nn2so(Hloc,Nspin,Norb))
