program ed_ti_slab
  ...
  !
  NHmat =zero
  NHmat(1:2,1:2) = (1 + xi)*NHFIELD_UP * pauli_tau_0
  NHmat(3:4,3:4) = (1 + xi)*NHFIELD_DW * pauli_tau_0
  !
  !
...
contains
  ...
  subroutine build_eigenbands(kpath_)
    ...
    kpath(1,:)=[0.0160,0.0,0.0]*pi
    kpath(2,:)=[0.0160,0.0,1.0]*pi
    kpath(3,:)=[0.0160,0.0,2.0]*pi
    kpath(4,:)=[1.0160,0.0,2.0]*pi
    kpath(5,:)=[2.0160,0.0,2.0]*pi
