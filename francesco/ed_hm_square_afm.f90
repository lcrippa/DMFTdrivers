...
contains
  ...
  !-------------------------------------------------------------------------------------------
  !Works for 1x1, 2x1, 2x2 hamiltonian matrices
  function hk_model(kpoint,N) result(hk_out)
    ...
    do ispin=1,Nspin
      do iorb=1,Norb
        Hk(1,2,ispin,ispin,iorb,iorb)=1 + exp(xi*2*kx)
        Hk(2,1,ispin,ispin,iorb,iorb)=1 + exp(-xi*2*kx)
        Hk(2,3,ispin,ispin,iorb,iorb)=1 + exp(xi*2*ky)
        Hk(3,2,ispin,ispin,iorb,iorb)=1 + exp(-xi*2*ky)
        Hk(3,4,ispin,ispin,iorb,iorb)=1 + exp(-xi*2*kx)
        Hk(4,3,ispin,ispin,iorb,iorb)=1 + exp(xi*2*kx)
        Hk(4,1,ispin,ispin,iorb,iorb)=1 + exp(-xi*2*ky)
        Hk(1,4,ispin,ispin,iorb,iorb)=1 + exp(xi*2*ky)
      enddo
    enddo
    hk_out=asdasd(hk)
  ...
  !+---------------------------------------------------------------------------+
   ...
   function asdasd(Fin) result(Fout)
